...
echo compressing...
PVRTexToolCLI.exe -i %1 -flip y -pot + -m -f ASTC_8x8,UBN,sRGB -q %quality% -shh -o %2-astc.ktx >junk.txt
...
PVRTexToolCLI.exe -i %1 -flip y -pot + -m -f %format%,UBN,sRGB -o %2-dxt.ktx
